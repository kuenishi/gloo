...
if(USE_ETCD)
  find_package(cetcd REQUIRED)
  if(CETCD_FOUND)
    include_directories(SYSTEM ${CETCD_INCLUDE_DIRS})
    list(APPEND gloo_DEPENDENCY_LIBS ${CETCD_LIBRARIES})
  else()
    message(WARNING "Not compiling with etcd support. Suppress this warning with -DUSE_ETCD=OFF.")
    set(USE_ETCD OFF)
  endif()
endif()
